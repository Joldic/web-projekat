...
INSERT INTO KORISNIK(AKTIVAN, DATUM_RODJENJA, E_MAIL, IME, KONTAKT_TELEFON, KORISNICKO_IME, LOZINKA, PREZIME, PROSECNA_OCENA, ULOGA, FITNESS_CENTAR_ID) VALUES (true, '1998-04-30','severina@gmail.com', 'Severina', '1234-789', 'severina','severina123','Kojic', 0, 2 , 1);
...
INSERT INTO TRENING(NAZIV, OPIS, TIP_TRENINGA, TRAJANJE, KORISNIK_ID) VALUES('Cardio', 'izdrzljivost', 'maraton', 120, 3);
INSERT INTO TRENING(NAZIV, OPIS, TIP_TRENINGA, TRAJANJE, KORISNIK_ID) VALUES('Cardio', 'izdrzljivost', 'maraton', 120, 5);
INSERT INTO TRENING(NAZIV, OPIS, TIP_TRENINGA, TRAJANJE, KORISNIK_ID) VALUES('CrossFit', 'snaga', 'kondicioni', 30, 5);
...
INSERT INTO TRENING(NAZIV, OPIS, TIP_TRENINGA, TRAJANJE, KORISNIK_ID) VALUES('Fitness', 'snaga', 'funkcionalni', 10, 3);
...
INSERT INTO PRIJAVA(OCENA, ODRADJEN, KORISNIK_ID, TERMIN_ID) VALUES(10, true, 2, 1);
INSERT INTO PRIJAVA(OCENA, ODRADJEN, KORISNIK_ID, TERMIN_ID) VALUES(0, true, 2, 2);
INSERT INTO PRIJAVA(OCENA, ODRADJEN, KORISNIK_ID, TERMIN_ID) VALUES(0, true, 2, 3);
INSERT INTO PRIJAVA(OCENA, ODRADJEN, KORISNIK_ID, TERMIN_ID) VALUES(0, true,2, 5);
